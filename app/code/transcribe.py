...
def transcribe(
    ...
    **decode_options,
    ...
    report_time_taken("Spectrogram takes: ")
    ...
    report_time_taken("Detecting language takes: ")
    ...
    report_time_taken("The main show: ")

    detected_text = dict(text=tokenizer.decode(all_tokens[len(initial_prompt):]), segments=all_segments, language=language)

    report_time_taken("Detokenization: ")
